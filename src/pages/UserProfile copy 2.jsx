...
function UserProfile() {
  ...
  return (
    <div className="pt-10 min-h-screen bg-gray-100">
            ...
            <div className="mb-4 md:mb-0 md:mr-6">
              {user.profilePicture ? (
                <img
                  ...
                  onClick={() => openMediaModal(`data:image/jpeg;base64,${user.profilePicture}`, 'image')}
                />
              ) : (
              ...
              {post.image && (
                <div className="mb-4">
                  <img
                    ...
                    onClick={() => openMediaModal(`data:image/jpeg;base64,${post.image}`, 'image')}
                  />
                </div>
              )}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4" onClick={closeMediaModal}>
